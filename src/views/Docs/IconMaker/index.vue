<template>
<div class="docs-icon-maker">
    <h3 class="maker-title">图标绘制</h3>
    <div class="maker-content">
        <div class="help-contents">
            <div class="svg-container" id="rule">
                <svg xmlns="http://www.w3.org/2000/svg" width="960" height="560" viewBox="0 0 960 560">
                    ...
                    <text transform="translate(232.39 85.865)" fill="#333" font-family="'MicrosoftYaHei'"
                          font-size="14">闭合
                    </text>
                    <text transform="translate(232.39 111.075)" fill="#999" font-family="'MicrosoftYaHei'"
                          font-size="12">图形需要封闭，不能有出现未闭合图形
                    </text>
                    <text transform="translate(232.39 246.325)" fill="#333" font-family="'MicrosoftYaHei'"
                          font-size="14">合并
                    </text>
                    <text transform="translate(232.39 271.534)">
                        <tspan x="0" y="0" fill="#999" font-family="'MicrosoftYaHei'" font-size="12">如果有两个以上图形，或者有布尔关系
                        </tspan>
                        <tspan x="0" y="20" fill="#999" font-family="'MicrosoftYaHei'" font-size="12">的图形，请对图形合并并且扩展
                        </tspan>
                    </text>
                    <text transform="translate(232.39 383.062)" fill="#333" font-family="'MicrosoftYaHei'"
                          font-size="14">大小
                    </text>
                    ...
                    <g fill="#0D0931">
                        ...
                        <path
                            d="M193.324 429.715H142.21v-51.369h51.114v51.369zm-50.154-.96h49.195v-49.449H143.17v49.449z"></path>
                    </g>
                    <g fill="#0D0931">
                        <path
                            d="M583.241 93.154l-.003 46.454h2.236V91.526c-.011-11.001-9.527-11.001-11.055-11.001H539.27v2.217h33.526c1.455.003 10.445.003 10.445 10.412z"></path>
                        <path d="M567.545 79.497h4.239v4.239h-4.239zm14.925 16.55h4.239v4.239h-4.239z"></path>
                    </g>
                    <g fill="#0D0931">
                        <path
                            d="M678.174 93.154l-.003 46.454h2.236V91.526c-.003-3.975 1.661-4.969 0-6.591-2.936-2.866-10.078-4.41-11.055-4.41h-35.149v2.217h33.526c1.455.003 10.445.003 10.445 10.412z"></path>
                        <path
                            d="M676.904 84.436h4.239v4.239h-4.239zm-13.731-4.939h4.239v4.239h-4.239zm13.731 16.55h4.239v4.239h-4.239z"></path>
        ...
        c12.672,0,22.944,10.272,22.944,22.944V765.897z"></path><circle fill="none" stroke="#666666" stroke-miterlimit="10" cx="518.915" cy="474.842" r="156"></circle><ellipse fill="none" stroke="#666666" stroke-miterlimit="10" cx="517.866" cy="474.842" rx="342.951" ry="344"></ellipse></svg>
                <div class="detail-right">图标在绘制时均以标准图标大小16x16px绘制，因为在制作成字体时文件需要 设置较高的清晰度，所以图标路径也需要等比例放大。</div>
            </div>
            <div class="contents-title">2. 设置图标大小</div>
            <div class="contents-detail">
        ...
        c6.776-7.774,14.567-9.739,23.325-6.503c4.929,1.642,9.113,5.623,11.62,11.093C663.844,566.163,663.878,571.465,661.439,577.75z"></path></svg>
                <div class="detail-right">设计师可以直接将画好的图标路径复制到模版里，根据模板的辅助线，对图标 进行位置的调节，居中，四周等距，保证图标的统一。</div>
            </div>
            <div class="contents-title">3. 另存为svg格式</div>
            <div class="contents-detail">
                <svg version="1.1" id="图层_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="453.833px" height="276.833px" viewBox="0 0 453.833 276.833" enable-background="new 0 0 453.833 276.833" xml:space="preserve"><path fill="#E8E8E8" d="M18.275,13.139h417.653c1.098,0,1.989,0.941,1.989,2.102v242.563c0,1.161-0.89,2.102-1.989,2.102H18.275
        ...
        C373.116,74.932,372.868,74.783,372.765,74.584z"></path><g><path fill="#979697" d="M343.042,113.626h-0.019c-0.019,0-0.056,0-0.056,0c-0.019,0-0.019,0-0.037,0c-0.037,0-0.093,0-0.13,0.015
          ...
          c-0.074,0.089-0.13,0.193-0.13,0.297C337.768,110.808,338.045,111.031,338.378,111.031z"></path></g></svg>
            </div>
        </div>
    </div>
</div>
